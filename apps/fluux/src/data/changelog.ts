    ...
    sections: [
      {
        ...
        items: [
          ...
          'Add contact button in profile screen',
      ...
      },
      {
        ...
        items: [
          ...
          'Reply arrow moved to avatar column for better visual connection to quoted message',
          'Hat creation form: replaced hue input with slider and live preview',
