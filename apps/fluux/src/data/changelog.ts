    ...
    sections: [
      {
        ...
        items: [
          ...
          'User and room avatars shown in search results',
          'Neighboring messages shown as context in sidebar search results',
          'Alt+Up/Down keyboard navigation in search results with preview loading',
      ...
      },
      {
        ...
        items: [
          ...
          'FAB badge count derived from new message marker position',
          'New message marker shown for conversations not yet opened in session',
          'Scroll positioning offset in search and activity context views',
          'Header misalignment and sidebar item spacing consistency',
          'App freeze after wake from sleep on different network',
          'Activity log rehydrated from localStorage on connect',
